...
### Currently accepted
Current accepted work: **#130 Add real b-roll image overlays to timed visual moments**. A PR must complete that issue's Acceptance through the normal product workflow.
