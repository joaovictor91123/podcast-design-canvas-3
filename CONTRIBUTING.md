...
### Currently accepted
Current accepted work: **#39 Add social-context setup before preview generation**. A PR must complete that issue's Acceptance through the normal product workflow.
