...
### Currently accepted
Current accepted work: **#58 Fix preset preview composition for Stack and Spotlight layouts**. A PR must complete that issue's Acceptance through the normal product workflow.
